(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~bill-bill-module~buy-product-buy-product-module~list-products-list-products-module~process-p~a1748329"],{
...
class ApiService {
    ...
    getProduct(id) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiEndpoint + `products/${id}`);
    }
    getPayment(id) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiEndpoint + `payments/${id}`);
    }
    sendCardInfo(card) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiEndpoint + 'card', card);
    }
    sendCustomerInfo(customer) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiEndpoint + 'customer', customer);
    }
    sendCardPayment(payment) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiEndpoint + 'payments/card', payment);
    }
}
...
//# sourceMappingURL=default~bill-bill-module~buy-product-buy-product-module~list-products-list-products-module~process-p~a1748329.js.map